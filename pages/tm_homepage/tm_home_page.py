...
class TmHomePage(BaseDriver):
    ...
    PROPERTY_BUTTON = (By.XPATH,
                       "//a[@class='tm-homepage-search-header__vertical-links-link tm-homepage-search-header__vertical-links-link--property']")
    ...
    def search_for_item_in_tm_homepage(self, item_name: str) -> None:
